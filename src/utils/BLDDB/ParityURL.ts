...
import { SpeffzEdgeToOrientedPosition } from "./EdgeToURL";
...
export function ParityURL(
  ...
  return `https://v2.blddb.net/parity?position=${SpeffzEdgeToOrientedPosition(
    edge1
  )}-${SpeffzEdgeToOrientedPosition(edge2)}-${SpeffzCornerToPosition(
    corner1
